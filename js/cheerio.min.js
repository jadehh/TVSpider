...
const s = e.Root, a = e.Text, o = e.Directive, c = e.Comment, l = e.Script, h = e.Style, u = e.Tag, p = e.CDATA,
    f = e.Doctype;
...
function v(e, t = !1) {
    let n;
    if (b(e)) n = new m(e.data); else if (O(e)) n = new T(e.data); else if (I(e)) {
        const r = t ? D(e.children) : [], i = new C(e.name, {...e.attribs}, r);
...
function _e(e) {
    return pe("media:content", e).map((e => {
        const {attribs: t} = e, n = {medium: t.medium, isDefault: !!t.isDefault};
        ...
        getFeed: function (e) {
            ...
            return t ? "feed" === t.name ? function (e) {
                ...
                const n = e.children, r = {
                    type: "atom", items: pe("entry", n).map((e => {
                        var t;
                        const {children: n} = e, r = {media: _e(n)};
                ...
                const r = null !== (n = null === (t = Ae("channel", e.children)) || void 0 === t ? void 0 : t.children) && void 0 !== n ? n : [],
                    i = {
                        type: e.name.substr(0, 3), id: "", items: pe("item", e.children).map((e => {
                            const {children: t} = e, n = {media: _e(t)};
...
ve.prototype = {}, De.prototype.runInContext = function (e) {
    ...
    if (be.document) {
        ...
        var s = Oe(n), a = r.call(n, this.code);
    ...
    var t = Re(e), n = this.runInContext(t);
...
var Pe = {
    ...
    }, isContext: Me, createContext: Re, createScript: function (e) {
        return new De(e)
    }, Script: De, runInThisContext: function (e, t) {
...
He.prototype.evaluate = function (e, t, n, r) {
    ...
    if (("string" != typeof l || o) && t && we.call(t, l)) p(this._trace(h, t[l], Be(n, l), t, l, s, a)); else if ("*" === l) this._walk(t, (e => {
        ...
        if ("$" === l) p(this._trace(h, t, n, null, null, s, a)); else if (/^(-?\d*):(-?\d*):?(\d*)$/u.test(l)) p(this._slice(l, h, t, n, r, i, s)); else if (0 === l.indexOf("?(")) {
...
var je = Ke((function (e) {
    ...
    function c(e, t, n) {
        ...
        if (e instanceof Error && (e = (i = e).name + ": " + i.message), Object.setPrototypeOf ? (r = new Error(e), Object.setPrototypeOf(r, c.prototype)) : (r = this, Object.defineProperty(r, "message", {
            ...
            writable: !0,
            value: e
        })), Object.defineProperty(r, "name", {value: "Template render error"}), Error.captureStackTrace && Error.captureStackTrace(r, this.constructor), i) {
...
var st = it, at = it, ot = it, ct = it, lt = it, ht = it, ut = it;
...
var Et = {
    ...
    hrtime: function (e) {
        var t = .001 * ft.call(pt), n = Math.floor(t), r = Math.floor(t % 1 * 1e9);
...
function At(e, t, n) {
    if (t) e.call(n); else for (var r = e.length, i = yt(e, r), s = 0; s < r; ++s) i[s].call(n)
}

function gt(e, t, n, r) {
    if (t) e.call(n, r); else for (var i = e.length, s = yt(e, i), a = 0; a < i; ++a) s[a].call(n, r)
}

function Nt(e, t, n, r, i) {
    if (t) e.call(n, r, i); else for (var s = e.length, a = yt(e, s), o = 0; o < s; ++o) a[o].call(n, r, i)
}

function Ct(e, t, n, r, i, s) {
    if (t) e.call(n, r, i, s); else for (var a = e.length, o = yt(e, a), c = 0; c < a; ++c) o[c].call(n, r, i, s)
}

function It(e, t, n, r) {
    if (t) e.apply(n, r); else for (var i = e.length, s = yt(e, i), a = 0; a < i; ++a) s[a].apply(n, r)
}
...
function St(e, t, n, r) {
    ...
    if ((s = e._events) ? (s.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), s = e._events), a = s[t]) : (s = e._events = new mt, e._eventsCount = 0), a) {
        if ("function" == typeof a ? a = s[t] = r ? [n, a] : [a, n] : r ? a.unshift(n) : a.push(n), !a.warned && (i = _t(e)) && i > 0 && a.length > i) {
            ...
            o.name = "MaxListenersExceededWarning", o.emitter = e, o.type = t, o.count = a.length, function (e) {
...
mt.prototype = Object.create(null), Tt.EventEmitter = Tt, Tt.usingDomains = !1, Tt.prototype.domain = void 0, Tt.prototype._events = void 0, Tt.prototype._maxListeners = void 0, Tt.defaultMaxListeners = 10, Tt.init = function () {
    ...
    if (n === t || n.listener && n.listener === t) 0 == --this._eventsCount ? this._events = new mt : (delete r[e], r.removeListener && this.emit("removeListener", e, n.listener || t)); else if ("function" != typeof n) {
...
var vt, Dt = {Domain: Lt, createDomain: kt, create: kt}, Rt = "function" == typeof setImmediate, Mt = Pt;
            ...
            var c = function (e) {
                return function (n) {
                    if (n) t.apply(null, arguments), t = function () {
                        ...
                        var r = Array.prototype.slice.call(arguments, 1), i = e.next();
...
var jt = function () {
    ...
    return t.nextToken = function () {
        ...
        var h,
            u = this.tags.BLOCK_START.charAt(0) + this.tags.VARIABLE_START.charAt(0) + this.tags.COMMENT_START.charAt(0) + this.tags.COMMENT_END.charAt(0);
        if (this.isFinished()) return null;
...
var Jt = function () {
    ...
    return Xt(t, e), t.prototype.init = function () {
...
var on = function (e) {
    ...
    }(on), hn = ln.extend("Root"), un = cn.extend("Literal"), pn = cn.extend("Symbol"), fn = ln.extend("Group"),
    dn = ln.extend("Array"), En = on.extend("Pair", {fields: ["key", "value"]}), mn = ln.extend("Dict"),
    Tn = on.extend("LookupVal", {fields: ["target", "val"]}), _n = on.extend("If", {fields: ["cond", "body", "else_"]}),
    An = _n.extend("IfAsync"), gn = on.extend("InlineIf", {fields: ["cond", "body", "else_"]}),
    Nn = on.extend("For", {fields: ["arr", "name", "body", "else_"]}), Cn = Nn.extend("AsyncEach"),
    In = Nn.extend("AsyncAll"), Sn = on.extend("Macro", {fields: ["name", "args", "body"]}), bn = Sn.extend("Caller"),
    On = on.extend("Import", {fields: ["template", "target", "withContext"]}), yn = function (e) {
        function t() {
            return e.apply(this, arguments) || this
        }
    ...
    }(on), Ln = on.extend("FunCall", {fields: ["name", "args"]}), kn = Ln.extend("Filter"),
    vn = kn.extend("FilterAsync", {fields: ["name", "args", "symbol"]}), Dn = mn.extend("KeywordArgs"),
    Rn = on.extend("Block", {fields: ["name", "body"]}), Mn = on.extend("Super", {fields: ["blockName", "symbol"]}),
    ...
    Fn = on.extend("Case", {fields: ["cond", "body"]}), Un = ln.extend("Output"),
    Hn = on.extend("Capture", {fields: ["body"]}), Gn = un.extend("TemplateData"),
    Yn = on.extend("UnaryOp", {fields: ["target"]}), qn = on.extend("BinOp", {fields: ["left", "right"]}),
    Kn = qn.extend("In"), jn = qn.extend("Is"), Vn = qn.extend("Or"), Wn = qn.extend("And"), Qn = Yn.extend("Not"),
    Xn = qn.extend("Add"), $n = qn.extend("Concat"), zn = qn.extend("Sub"), Jn = qn.extend("Mul"),
    Zn = qn.extend("Div"), er = qn.extend("FloorDiv"), tr = qn.extend("Mod"), nr = qn.extend("Pow"),
    rr = Yn.extend("Neg"), ir = Yn.extend("Pos"), sr = on.extend("Compare", {fields: ["expr", "ops"]}),
    ar = on.extend("CompareOperand", {fields: ["expr", "type"]}), or = on.extend("CallExtension", {
...
var pr = function (e) {
    ...
    return i.init = function (e) {
        ...
        var t = this.parsePrimary(!0), n = this.parseSignature(), r = new hr.Macro(e.lineno, e.colno, t, n);
        ...
        var t = this.parseSignature(!0) || new hr.NodeList, n = this.parsePrimary();
        this.advanceAfterBlockEnd(e.value);
        var r = this.parseUntilBlocks("endcall");
        this.advanceAfterBlockEnd();
        var i = new hr.Symbol(e.lineno, e.colno, "caller"), s = new hr.Caller(e.lineno, e.colno, i, t, r),
            a = n.args.children;
        ...
        var n = this.parseExpression(), r = this.parseWithContext(), i = new hr.Import(e.lineno, e.colno, t, n, r);
        ...
        for (var t, n = new hr.Set(e.lineno, e.colno, []); (t = this.parsePrimary()) && (n.targets.push(t), this.skip(Vt.TOKEN_COMMA));) ;
        ...
        for (var t, n = this.peekToken(); n;) {
            if (n.type === Vt.TOKEN_LEFT_PAREN) e = new hr.FunCall(n.lineno, n.colno, e, this.parseSignature()); else if (n.type === Vt.TOKEN_LEFT_BRACKET) (t = this.parseAggregate()).children.length > 1 && this.fail("invalid index"), e = new hr.LookupVal(n.lineno, n.colno, e, t.children[0]); else {
        ...
        for (var r = new hr.NodeList(n.lineno, n.colno), i = new hr.KeywordArgs(n.lineno, n.colno), s = !1; ;) {
            ...
            if (s && !this.skip(Vt.TOKEN_COMMA)) this.fail("parseSignature: expected comma after expression", n.lineno, n.colno); else {
...
function Tr(e, t, n) {
    ...
    if (e instanceof hr.NodeList) {
        ...
        var s = Tr(e.args, t, n), a = mr(e.contentArgs, (function (e) {
            return Tr(e, t, n)
        }));
...
}, Cr = Array.from, Ir = "function" == typeof Symbol && Symbol.iterator && "function" == typeof Cr, Sr = function () {
    function e(e, t) {
...
var kr = {
    Frame: Sr, makeMacro: function (e, t, n) {
        return function () {
    ...
    }, numArgs: yr, suppressValue: function (e, t) {
    ...
    }, isArray: je.isArray, keys: je.keys, SafeString: Lr, copySafeness: function (e, t) {
        ...
        if (je.isArray(e)) if (i = e.length, s = new Array(i), 0 === i) r(null, ""); else for (var c = 0; c < e.length; c++) {
            var l = e[c];
            switch (t) {
                case 1:
                    n(l, c, i, o);
            ...
            var h = je.keys(e || {});
            if (i = h.length, s = new Array(i), 0 === i) r(null, ""); else for (var u = 0; u < h.length; u++) {
                var p = h[u];
                n(p, e[p], u, i, o)
            }
        }
    }, inOperator: je.inOperator, fromIterator: function (e) {
...
var Dr = je.TemplateError, Rr = kr.Frame,
    Mr = {"==": "==", "===": "===", "!=": "!=", "!==": "!==", "<": "<", ">": ">", "<=": "<=", ">=": ">="},
    Pr = function (e) {
        var t, n;
        ...
        return i.init = function (e, t) {
            ...
            var n = this, r = this._tmpid(), i = this._tmpid(), s = this._tmpid();
            if (t = t.push(), this._emitLine("frame = frame.push();"), this._emit("var " + s + " = "), this._compileExpression(e.arr, t), this._emitLine(";"), this._emit("if(" + s + ") {"), this._emitLine(s + " = runtime.fromIterator(" + s + ");"), e.name instanceof hr.Array) {
                ...
                var a = e.name.children, o = a[0], c = a[1], l = this._tmpid(), h = this._tmpid();
            ...
            var r = this, i = this._tmpid(), s = this._tmpid(), a = this._tmpid(), o = n ? "asyncAll" : "asyncEach";
            ...
            var i = this._tmpid(), s = this._templateName(), a = this._makeCallback(i), o = n ? "true" : "false",
                c = r ? "true" : "false";
        ...
        compile: function (e, t, n, r, i) {
            void 0 === i && (i = {});
            var s = new Pr(r, i.throwOnUndefined), a = (n || []).map((function (e) {
                return e.preprocess
            })).filter((function (e) {
                return !!e
            })).reduce((function (e, t) {
        ...
        t.abs = Math.abs, t.batch = function (e, t, n) {
            ...
            var r = t - e.length, i = je.repeat(" ", r / 2 - r % 2), s = je.repeat(" ", r / 2);
            ...
            var i = this, s = je.map(e, (function (e) {
                return e
            })), a = je.getAttrGetter(r);
            return s.sort((function (e, s) {
                var o = r ? a(e) : e, c = r ? a(s) : s;
            ...
            var r = o((e = n(e, "")).replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>|<!--[\s\S]*?-->/gi, "")), i = "";
        ...
        t.urlize = function (e, t, n) {
            ...
            return e.split(/(\s+)/).filter((function (e) {
                ...
                var n = e.match(c), r = n ? n[1] : e, s = r.substr(0, t);
...
var Kr = {
    ...
    }, isAbsolute: qr, normalize: Yr, resolve: Gr
};
...
var Zr = {PrecompiledLoader: $r}.PrecompiledLoader, ei = function (e) {
    function t(t, n) {
        var r;
    ...
    return zr(t, e), t.prototype.getSource = function (e) {
        for (var t = null, n = this.searchPaths, r = 0; r < n.length; r++) {
            var i = Kr.resolve(n[r]), s = Kr.resolve(n[r], e);
    ...
    FileSystemLoader: ei, PrecompiledLoader: Zr, NodeResolveLoader: function (e) {
        function t(t) {
            var n;
...
var ii = function () {
    return {
        range: function (e, t, n) {
            ...
            var r = [];
            if (n > 0) for (var i = e; i < t; i += n) r.push(i); else for (var s = e; s > t; s += n) r.push(s);
            return r
        }, cycler: function () {
...
var oi = ti.FileSystemLoader, ci = ti.WebLoader, li = ti.PrecompiledLoader, hi = en.Obj, ui = en.EmitterObj,
    pi = kr.handleError, fi = kr.Frame;
...
var Ei = {
    ...
    return n.init = function (e, t) {
        ...
        if (e && e.raw && (e = e.raw), je.isFunction(n) && (i = n, n = null, t = t || !1), je.isFunction(t) && (i = t, t = !1), e instanceof _i) c = e; else {
    ...
    return n.init = function (e, t, n) {
        ...
        var a = je.indexOf(this.blocks[t] || [], n), o = this.blocks[t][a + 1];
    ...
    return n.init = function (e, t, n, r) {
        ...
        var a = new Ti(e || {}, this.blocks, this.env), o = t ? t.push(!0) : new fi;
        o.topLevel = !0;
        var c = null, l = !1;
        return this.rootRenderFunc(this.env, a, o, kr, (function (e, t) {
            if (!l || !n || void 0 === t) if (e && (e = je._prettifyError(r.path, r.env.opts.dev, e), l = !0), n) i ? di(n, e, t) : n(e, t); else {
                if (e) throw e;
                c = t
            }
        })), c
...
}(hi), Ai = {Environment: mi, Template: _i};
je._prettifyError;
...
var Hi = Object.prototype.hasOwnProperty, Gi = /\s+/, Yi = {null: null, true: !0, false: !1},
...
function $i(e, t) {
    ...
    for (var a = 0; a < n.length; ++a) {
        ...
        if (Hi.call(e.attribs, o) && !Hi.call(e.data, c)) {
            if (i = e.attribs[o], Hi.call(Yi, i)) i = Yi[i]; else if (i === String(Number(i))) i = Number(i); else if (Ki.test(i)) try {
                i = JSON.parse(i)
            } catch (e) {
            }
            e.data[c] = i
...
var Zi, es, ts = Object.freeze({
    __proto__: null, attr: function (e, t) {
        ...
        return this.toArray().some((function (t) {
            var n = I(t) && t.attribs.class, r = -1;
            if (n && e.length) for (; (r = n.indexOf(e, r + 1)) > -1;) {
                var i = r + e.length;
        ...
        var n = Ji(t), r = n.length, i = 0 === arguments.length;
        return Bi(this, (function (e) {
            if (I(e)) if (i) e.attribs.class = ""; else {
...
const ns = /^[^\\#]?(?:\\(?:[\da-f]{1,6}\s?|.)|[\w\-\u00b0-\uFFFF])+/, rs = /\\([\da-f]{1,6}\s?|(\s)|.)/gi,
...
var Os = Ke((function (e, t) {
    ...
    var n = new Set([9, 10, 12, 13, 32]), r = "0".charCodeAt(0), i = "9".charCodeAt(0);
    t.parse = function (e) {
...
var ys = Ke((function (e, t) {
    Object.defineProperty(t, "__esModule", {value: !0}), t.compile = void 0, t.compile = function (e) {
        var t = e[0], n = e[1] - 1;
...
qe(ys), ys.compile;
var Ls = Os, ks = ys, vs = Ke((function (e, t) {
    Object.defineProperty(t, "__esModule", {value: !0}), t.compile = t.parse = void 0, Object.defineProperty(t, "parse", {
        enumerable: !0,
        get: function () {
            return Ls.parse
        }
...
const Ms = {
    ...
    }, hover: Ps("isHovered"), visited: Ps("isVisited"), active: Ps("isActive")
};
...
const Gs = (e, t, n, r, i) => {
    ...
    is: Gs, matches: Gs, where: Gs, not(e, t, n, r, i) {
        const s = i(t, Hs(n), r);
        return s === ds.falseFunc ? e : s === ds.trueFunc ? ds.falseFunc : t => !s(t) && e(t)
    }, has(e, t, n, r, i) {
        const {adapter: s} = n, a = Hs(n);
...
const Vs = {type: Zi.Descendant}, Ws = {type: "_flexibleDescendant"}, Qs = {type: Zi.Pseudo, name: "scope", data: null};
...
function Xs(e, t, n) {
    ...
    if (!1 !== t.relativeSelector) !function (e, {adapter: t}, n) {
        ...
        for (const t of e) {
            if (t.length > 0 && Ts(t[0]) && t[0].type !== Zi.Descendant) ; else {
                if (!r || t.some(js)) continue;
                t.unshift(Vs)
            }
            t.unshift(Qs)
        }
    }(e, t, s); else if (e.some((e => e.length > 0 && Ts(e[0])))) throw new Error("Relative selectors are not allowed when the `relativeSelector` option is disabled");
    let a = !1;
    const o = e.map((e => {
        if (e.length >= 2) {
            const [t, n] = e;
...
const zs = (e, t) => e === t, Js = {adapter: Se, equals: zs};
...
const sa = {type: Zi.Universal, namespace: null}, aa = {type: Zi.Pseudo, name: "scope", data: null};
...
function ua(e, t, n) {
    ...
    if (e.some(as)) {
        const i = null !== (r = n.root) && void 0 !== r ? r : function (e) {
            ...
            return e
        }(t[0]), s = {...n, context: t, relativeSelector: !1};
...
var wa = Object.freeze({
    ...
    find: function (e) {
        ...
        var i = Ta.test(e) ? n : this.children().toArray(), s = {
            context: n,
    ...
    add: function (e, t) {
        var n = this._make(e, t), r = Ee(ma(ma([], this.get(), !0), n.get(), !0));
        return this._make(r)
    },
    addBack: function (e) {
...
var Va = Object.freeze({
    __proto__: null, _makeDomArray: function (e, t) {
    ...
    }, append: Ga, prepend: Ya, wrap: Ka, wrapInner: ja, unwrap: function (e) {
        var t = this;
        ...
        return Bi(this, (function (n, i) {
            var s = n.parent;
            if (k(n) && s) {
                var a = s.children, o = a.indexOf(n);
                if (!(o < 0)) {
        ...
        return this._makeDomArray(e).forEach((function (e) {
            ...
            if (i) {
                var s = i.children, a = s.indexOf(e);
        ...
        return Bi(this, (function (n, r) {
            var i = n.parent;
            if (i) {
                var s = i.children, a = "function" == typeof e ? e.call(n, r, n) : e, o = t._makeDomArray(a);
                Ba(o, null);
                var c = s.indexOf(n);
...
function Wa(e, t, n, r) {
    if ("string" == typeof t) {
        var i = Qa(e), s = "function" == typeof n ? n.call(e, r, i[t]) : n;
...
var eo, to = (eo = function (e, t) {
    return eo = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (e, t) {
        e.__proto__ = t
    } || function (e, t) {
...
var Co = Ao, Io = go, So = No, bo = Ke((function (e, t) {
    ...
    function l(e) {
        return function (t, n) {
            for (var r = "", i = 0, c = 0; (c = t.indexOf("&", c)) >= 0;) if (r += t.slice(i, c), i = c, c += 1, t.charCodeAt(c) !== a.NUM) {
                ...
                var m = c + 1, T = 10, _ = t.charCodeAt(m);
                ...
                if (m !== c) {
                    var A = t.substring(m, c), g = parseInt(A, T);
                    if (t.charCodeAt(c) === a.SEMI) c += 1; else if (n) continue;
                    r += (0, s.default)(g), i = c
                }
            }
            return r + t.slice(i)
    ...
    function h(e, t, n, r) {
        var i = (t & o.BRANCH_LENGTH) >> 7, s = t & o.JUMP_TABLE;
    ...
    var u = l(r.default), p = l(i.default);
...
var Oo = bo.determineBranch, yo = bo.BinTrieFlags, Lo = bo.fromCodePoint, ko = bo.replaceCodePoint;
bo.decodeCodePoint;
...
class tc {
    ...
    _stateTagOpen(e) {
        if (Qo(e)) this._createStartTagToken(), this.state = Ko.TAG_NAME, this._stateTagName(e); else switch (e) {
    ...
    _stateEndTagOpen(e) {
        if (Qo(e)) this._createEndTagToken(), this.state = Ko.TAG_NAME, this._stateTagName(e); else switch (e) {
    ...
    _stateBeforeDoctypeName(e) {
        if (Wo(e)) this._createDoctypeToken(String.fromCharCode(Jo(e))), this.state = Ko.DOCTYPE_NAME; else switch (e) {
            case io.SPACE:
            case io.LINE_FEED:
            case io.TABULATION:
            case io.FORM_FEED:
...
const nc = new Set([Po.DD, Po.DT, Po.LI, Po.OPTGROUP, Po.OPTION, Po.P, Po.RB, Po.RP, Po.RT, Po.RTC]),
    ...
    sc = [Po.H1, Po.H2, Po.H3, Po.H4, Po.H5, Po.H6], ac = [Po.TR, Po.TEMPLATE, Po.HTML],
    oc = [Po.TBODY, Po.TFOOT, Po.THEAD, Po.TEMPLATE, Po.HTML], cc = [Po.TABLE, Po.TEMPLATE, Po.HTML],
    lc = [Po.TD, Po.TH];
...
const Cc = "text/html", Ic = "application/xhtml+xml",
    ...
    bc = new Map([["xlink:actuate", {
        ...
        name: "actuate",
        namespace: vo.XLINK
    }], ["xlink:arcrole", {prefix: "xlink", name: "arcrole", namespace: vo.XLINK}], ["xlink:href", {
        prefix: "xlink",
        name: "href",
        namespace: vo.XLINK
    }], ["xlink:role", {prefix: "xlink", name: "role", namespace: vo.XLINK}], ["xlink:show", {
        prefix: "xlink",
        name: "show",
        namespace: vo.XLINK
    }], ["xlink:title", {prefix: "xlink", name: "title", namespace: vo.XLINK}], ["xlink:type", {
        prefix: "xlink",
        name: "type",
        namespace: vo.XLINK
    }], ["xml:base", {prefix: "xml", name: "base", namespace: vo.XML}], ["xml:lang", {
        prefix: "xml",
        name: "lang",
        namespace: vo.XML
    }], ["xml:space", {prefix: "xml", name: "space", namespace: vo.XML}], ["xmlns", {
        prefix: "",
        name: "xmlns",
        namespace: vo.XMLNS
...
class wc {
    ...
    onComment(e) {
        if (this.skipNextNewLine = !1, this.currentNotInHTML) Kc(this, e); else switch (this.insertionMode) {
            case Rc.INITIAL:
            case Rc.BEFORE_HTML:
            case Rc.BEFORE_HEAD:
            case Rc.IN_HEAD:
    ...
    _processStartTag(e) {
        this.shouldProcessStartTagTokenInForeignContent(e) ? function (e, t) {
            ...
            }(t)) Dl(e), e._startTagOutsideForeignContent(t); else {
...
function Yc(e, t, n) {
    const r = e.treeAdapter.getNamespaceURI(n.element), {token: i} = n,
...
function Tl(e, t) {
    let n = 0;
    if (e.hasNonWhitespacePendingCharacterToken) for (; n < e.pendingCharacterTokens.length; n++) dl(e, e.pendingCharacterTokens[n]); else for (; n < e.pendingCharacterTokens.length; n++) e._insertCharacters(e.pendingCharacterTokens[n]);
...
var Rl = Ke((function (e, t) {
    ...
    function r(e) {
        for (var r, i = "", s = 0; null !== (r = t.xmlReplacer.exec(e));) {
            var a = r.index, o = e.charCodeAt(a), c = n.get(o);
...
qe(Rl);
var Ml = Rl.escapeText, Pl = Rl.escapeAttribute;
...
function Fl(e, t) {
    return t.treeAdapter.isElementNode(e) ? function (e, t) {
        ...
        const {treeAdapter: n} = t, r = n.getTextNodeContent(e), i = n.getParentNode(e),
            s = i && n.isElementNode(i) && n.getTagName(i);
        return s && n.getNamespaceURI(i) === vo.HTML && (a = s, o = t.scriptingEnabled, Yo.has(a) || o && a === Mo.NOSCRIPT) ? r : Ml(r);
        var a, o
...
const Gl = {
    ...
    insertBefore(e, t, n) {
        const r = e.children.indexOf(n), {prev: i} = n;
    ...
    setDocumentType(e, t, n, r) {
        ...
        s ? s.data = null != i ? i : null : (s = new _("!doctype", i), Gl.appendChild(e, s)), s["x-name"] = null != t ? t : void 0, s["x-publicId"] = null != n ? n : void 0, s["x-systemId"] = null != r ? r : void 0
    },
    setDocumentMode(e, t) {
        e["x-mode"] = t
    },
...
var Kl, jl, Vl, Wl = {treeAdapter: Gl};
...
class Jl {
    ...
    stateText(e) {
        e === Kl.Lt || !this.decodeEntities && this.fastForwardTo(Kl.Lt) ? (this.index > this.sectionStart && this.cbs.ontext(this.sectionStart, this.index), this.state = jl.BeforeTagName, this.sectionStart = this.index) : this.decodeEntities && e === Kl.Amp && (this.state = jl.BeforeEntity)
    }
    ...
    stateCDATASequence(e) {
        e === zl.Cdata[this.sequenceIndex] ? ++this.sequenceIndex === zl.Cdata.length && (this.state = jl.InCommentLike, this.currentSequence = zl.CdataEnd, this.sequenceIndex = 0, this.sectionStart = this.index + 1) : (this.sequenceIndex = 0, this.state = jl.InDeclaration, this.stateInDeclaration(e))
    }
    ...
    startSpecial(e, t) {
        this.isSpecial = !0, this.currentSequence = e, this.sequenceIndex = t, this.state = jl.SpecialStartSequence
    }

    stateBeforeTagName(e) {
        if (e === Kl.ExclamationMark) this.state = jl.BeforeDeclaration, this.sectionStart = this.index + 1; else if (e === Kl.Questionmark) this.state = jl.InProcessingInstruction, this.sectionStart = this.index + 1; else if (this.isTagStartChar(e)) {
            const t = 32 | e;
            this.sectionStart = this.index, this.xmlMode || t !== zl.TitleEnd[2] ? this.state = this.xmlMode || t !== zl.ScriptEnd[2] ? jl.InTagName : jl.BeforeSpecialS : this.startSpecial(zl.TitleEnd, 3)
        } else e === Kl.Slash ? this.state = jl.BeforeClosingTagName : (this.state = jl.Text, this.stateText(e))
    }

    stateInTagName(e) {
        Xl(e) && (this.cbs.onopentagname(this.sectionStart, this.index), this.sectionStart = -1, this.state = jl.BeforeAttributeName, this.stateBeforeAttributeName(e))
    }

    stateBeforeClosingTagName(e) {
        Ql(e) || (e === Kl.Gt ? this.state = jl.Text : (this.state = this.isTagStartChar(e) ? jl.InClosingTagName : jl.InSpecialComment, this.sectionStart = this.index))
    }

    stateInClosingTagName(e) {
        (e === Kl.Gt || Ql(e)) && (this.cbs.onclosetag(this.sectionStart, this.index), this.sectionStart = -1, this.state = jl.AfterClosingTagName, this.stateAfterClosingTagName(e))
    }
    ...
    stateBeforeAttributeName(e) {
        e === Kl.Gt ? (this.cbs.onopentagend(this.index), this.isSpecial ? (this.state = jl.InSpecialTag, this.sequenceIndex = 0) : this.state = jl.Text, this.baseState = this.state, this.sectionStart = this.index + 1) : e === Kl.Slash ? this.state = jl.InSelfClosingTag : Ql(e) || (this.state = jl.InAttributeName, this.sectionStart = this.index)
    }

    stateInSelfClosingTag(e) {
        e === Kl.Gt ? (this.cbs.onselfclosingtag(this.index), this.state = jl.Text, this.baseState = jl.Text, this.sectionStart = this.index + 1, this.isSpecial = !1) : Ql(e) || (this.state = jl.BeforeAttributeName, this.stateBeforeAttributeName(e))
    }

    stateInAttributeName(e) {
        (e === Kl.Eq || Xl(e)) && (this.cbs.onattribname(this.sectionStart, this.index), this.sectionStart = -1, this.state = jl.AfterAttributeName, this.stateAfterAttributeName(e))
    }

    stateAfterAttributeName(e) {
        e === Kl.Eq ? this.state = jl.BeforeAttributeValue : e === Kl.Slash || e === Kl.Gt ? (this.cbs.onattribend(Vl.NoValue, this.index), this.state = jl.BeforeAttributeName, this.stateBeforeAttributeName(e)) : Ql(e) || (this.cbs.onattribend(Vl.NoValue, this.index), this.state = jl.InAttributeName, this.sectionStart = this.index)
    }

    stateBeforeAttributeValue(e) {
        e === Kl.DoubleQuote ? (this.state = jl.InAttributeValueDq, this.sectionStart = this.index + 1) : e === Kl.SingleQuote ? (this.state = jl.InAttributeValueSq, this.sectionStart = this.index + 1) : Ql(e) || (this.sectionStart = this.index, this.state = jl.InAttributeValueNq, this.stateInAttributeValueNoQuotes(e))
    }

    handleInAttributeValue(e, t) {
        e === t || !this.decodeEntities && this.fastForwardTo(t) ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(t === Kl.DoubleQuote ? Vl.Double : Vl.Single, this.index), this.state = jl.BeforeAttributeName) : this.decodeEntities && e === Kl.Amp && (this.baseState = this.state, this.state = jl.BeforeEntity)
    }
    ...
    stateInAttributeValueNoQuotes(e) {
        Ql(e) || e === Kl.Gt ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(Vl.Unquoted, this.index), this.state = jl.BeforeAttributeName, this.stateBeforeAttributeName(e)) : this.decodeEntities && e === Kl.Amp && (this.baseState = this.state, this.state = jl.BeforeEntity)
    }

    stateBeforeDeclaration(e) {
        e === Kl.OpeningSquareBracket ? (this.state = jl.CDATASequence, this.sequenceIndex = 0) : this.state = e === Kl.Dash ? jl.BeforeComment : jl.InDeclaration
    }

    stateInDeclaration(e) {
        (e === Kl.Gt || this.fastForwardTo(Kl.Gt)) && (this.cbs.ondeclaration(this.sectionStart, this.index), this.state = jl.Text, this.sectionStart = this.index + 1)
    }

    stateInProcessingInstruction(e) {
        (e === Kl.Gt || this.fastForwardTo(Kl.Gt)) && (this.cbs.onprocessinginstruction(this.sectionStart, this.index), this.state = jl.Text, this.sectionStart = this.index + 1)
    }

    stateBeforeComment(e) {
        e === Kl.Dash ? (this.state = jl.InCommentLike, this.currentSequence = zl.CommentEnd, this.sequenceIndex = 2, this.sectionStart = this.index + 1) : this.state = jl.InDeclaration
    }

    stateInSpecialComment(e) {
        (e === Kl.Gt || this.fastForwardTo(Kl.Gt)) && (this.cbs.oncomment(this.sectionStart, this.index, 0), this.state = jl.Text, this.sectionStart = this.index + 1)
    }

    stateBeforeSpecialS(e) {
        const t = 32 | e;
        t === zl.ScriptEnd[3] ? this.startSpecial(zl.ScriptEnd, 4) : t === zl.StyleEnd[3] ? this.startSpecial(zl.StyleEnd, 4) : (this.state = jl.InTagName, this.stateInTagName(e))
    }

    stateBeforeEntity(e) {
        this.entityExcess = 1, this.entityResult = 0, e === Kl.Num ? this.state = jl.BeforeNumericEntity : e === Kl.Amp || (this.trieIndex = 0, this.trieCurrent = this.entityTrie[0], this.state = jl.InNamedEntity, this.stateInNamedEntity(e))
    }

    stateInNamedEntity(e) {
        if (this.entityExcess += 1, this.trieIndex = Oo(this.entityTrie, this.trieCurrent, this.trieIndex + 1, e), this.trieIndex < 0) return this.emitNamedEntity(), void this.index--;
        ...
        if (t) {
            ...
            if (this.allowLegacyEntity() || e === Kl.Semi) {
                ...
                e > this.sectionStart && this.emitPartial(this.sectionStart, e), this.entityResult = this.trieIndex, this.trieIndex += n, this.entityExcess = 0, this.sectionStart = this.index + 1, 0 === n && this.emitNamedEntity()
    ...
    stateBeforeNumericEntity(e) {
        (32 | e) === Kl.LowerX ? (this.entityExcess++, this.state = jl.InHexEntity) : (this.state = jl.InNumericEntity, this.stateInNumericEntity(e))
    }

    emitNumericEntity(e) {
        const t = this.index - this.entityExcess - 1;
        t + 2 + Number(this.state === jl.InHexEntity) !== this.index && (t > this.sectionStart && this.emitPartial(this.sectionStart, t), this.sectionStart = this.index + Number(e), this.emitCodePoint(ko(this.entityResult))), this.state = this.baseState
    }

    stateInNumericEntity(e) {
        e === Kl.Semi ? this.emitNumericEntity(!0) : $l(e) ? (this.entityResult = 10 * this.entityResult + (e - Kl.Zero), this.entityExcess++) : (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : this.state = this.baseState, this.index--)
    }

    stateInHexEntity(e) {
        e === Kl.Semi ? this.emitNumericEntity(!0) : $l(e) ? (this.entityResult = 16 * this.entityResult + (e - Kl.Zero), this.entityExcess++) : !function (e) {
            return e >= Kl.UpperA && e <= Kl.UpperF || e >= Kl.LowerA && e <= Kl.LowerF
        }(e) ? (this.allowLegacyEntity() ? this.emitNumericEntity(!1) : this.state = this.baseState, this.index--) : (this.entityResult = 16 * this.entityResult + ((32 | e) - Kl.LowerA + 10), this.entityExcess++)
    }
    ...
    finish() {
        this.state === jl.InNamedEntity && this.emitNamedEntity(), this.sectionStart < this.index && this.handleTrailingData(), this.cbs.onend()
    }
...
const Zl = new Set(["input", "option", "optgroup", "select", "button", "datalist", "textarea"]), eh = new Set(["p"]),
    th = new Set(["thead", "tbody"]), nh = new Set(["dd", "dt"]), rh = new Set(["rt", "rp"]),
    ...
    ah = new Set(["math", "svg"]),
    oh = new Set(["mi", "mo", "mn", "ms", "mtext", "annotation-xml", "foreignobject", "desc", "title"]), ch = /\s|\//;
...
class lh {
    ...
    ontextentity(e) {
        ...
        this.endIndex = r - 1, null === (n = (t = this.cbs).ontext) || void 0 === n || n.call(t, Lo(e)), this.startIndex = r
    }
    ...
    emitOpenTag(e) {
        ...
        this.isVoidElement(e) || (this.stack.push(e), ah.has(e) ? this.foreignContext.push(!0) : oh.has(e) && this.foreignContext.push(!1)), null === (i = (r = this.cbs).onopentagname) || void 0 === i || i.call(r, e), this.cbs.onopentag && (this.attribs = {})
    }
    ...
    onclosetag(e, t) {
        ...
        if (this.lowerCaseTagNames && (c = c.toLowerCase()), (ah.has(c) || oh.has(c)) && this.foreignContext.pop(), this.isVoidElement(c)) this.options.xmlMode || "br" !== c || (null === (r = (n = this.cbs).onopentagname) || void 0 === r || r.call(n, "br"), null === (s = (i = this.cbs).onopentag) || void 0 === s || s.call(i, "br", {}, !0), null === (o = (a = this.cbs).onclosetag) || void 0 === o || o.call(a, "br", !1)); else {
    ...
    onattribend(e, t) {
        var n, r;
        this.endIndex = t, null === (r = (n = this.cbs).onattribute) || void 0 === r || r.call(n, this.attribname, this.attribvalue, e === Vl.Double ? '"' : e === Vl.Single ? "'" : e === Vl.NoValue ? void 0 : null), this.attribs && !Object.prototype.hasOwnProperty.call(this.attribs, this.attribname) && (this.attribs[this.attribname] = this.attribvalue), this.attribvalue = ""
    }
    ...
    oncomment(e, t, n) {
        var r, i, s, a;
        this.endIndex = t, null === (i = (r = this.cbs).oncomment) || void 0 === i || i.call(r, this.getSlice(e, t - n)), null === (a = (s = this.cbs).oncommentend) || void 0 === a || a.call(s), this.startIndex = t + 1
    }
    ...
    write(e) {
        ...
        var t, n;
        this.ended ? null === (n = (t = this.cbs).onerror) || void 0 === n || n.call(t, Error(".end() after done!")) : (e && this.write(e), this.ended = !0, this.tokenizer.end())
    }
...
var hh = function (e) {
    return function (t, n, r, i) {
        if ("undefined" != typeof Buffer && Buffer.isBuffer(t) && (t = t.toString()), "string" == typeof t) return e(t, n, r, i);
        var s = t;
    ...
    return function r(s, a, o) {
        ...
        var c = no(no({}, n), i(a)), l = e(s, c, o, null), h = function (n) {
            function r() {
                return null !== n && n.apply(this, arguments) || this
            }

            return to(r, n), r.prototype._make = function (e, t) {
                var n = u(e, t);
        ...
        function u(t, n, r, s) {
            ...
            var a = no(no({}, c), i(s)), o = "string" == typeof r ? [e(r, a, !1, null)] : "length" in r ? r : [r],
                u = wi(o) ? o : new h(o, null, a);
            if (u._root = u, !t) return new h(void 0, u, a);
            var p,
                f = "string" == typeof t && Ui(t) ? e(t, a, !1, null).children : (p = t).name || "root" === p.type || "text" === p.type || "comment" === p.type ? [t] : Array.isArray(t) ? t : void 0,
                d = new h(f, u, a);
            if (f) return d;
            if ("string" != typeof t) throw new Error("Unexpected type of selector");
            var E = t,
                m = n ? "string" == typeof n ? Ui(n) ? new h([e(n, a, !1, null)], u, a) : (E = "".concat(n, " ").concat(E), u) : wi(n) ? n : new h(Array.isArray(n) ? n : [n], u, a) : u;
            return m ? m.find(E) : d
        }
    ...
    return t.xmlMode || t._useHtmlParser2 ? V(e, t) : function (e) {
        for (var t, n = ("length" in e ? e : [e]), r = 0; r < n.length; r += 1) L(s = n[r]) && (t = Array.prototype.splice).call.apply(t, Yl([n, r, 1], s.children, !1));
        var i = "";
...
var Eh = uh([]), mh = Di, Th = Ri, _h = ki, Ah = vi;
export {
    mh as contains,
    Eh as default,
    Oi as html,
