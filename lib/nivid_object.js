...
class ChannelResponse {
    ...
    getFilters() {
        ...
        for (const channel_info of this.channelList) {
            ...
            filters[channel_info.channelId].push({"key": "2", "name": "语言", "value": langValues})
            ...
            filters[channel_info.channelId].push({"key": "4", "name": "剧情", "value": typeValues})
    ...
    toSpilder(vod_list = null) {
        let homeSpiderResult = new HomeSpiderResult()
        return homeSpiderResult.setHomeSpiderResult(this.getClassList(), vod_list, this.getFilters()).toString()
    }
