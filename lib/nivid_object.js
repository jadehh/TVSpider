...
async function createSign(body = null) {
    let params = {
        "_ts": 1703069118031, "app_version": "1.0",
        "platform": "3", "market_id": "web_nivod",
        "device_code": "web", "versioncode": 1,
        "oid": "f8e6a9f427d4b57e909cec158022b3e27939797c57524fa7"
    }
    /**
    ...
    let params_str = "__QUERY::" + params_list.join("&") + "&__BODY::" + body_list.join("&") + "__KEY::2x_Give_it_a_shot"
