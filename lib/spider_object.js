...
class Result {
    ...
    string(classes,list,filters) {
        return this.get().classes(classes).vod(list).filters(filters).toString();
    }
    ...
    homeVod(vod_list){
        return this.get().vod(vod_list).toString()
    }
    category(vod_list,page,count,limit,total){
         return this.get().vod(vod_list).setPage(page,count,limit,total).toString()
    }
    get() {
        return new Result();
    }
