...
class User {
    ...
    async save() {
        if (db !== null){
              await db.push("ali_aliyundrive_user", this.toDict());
        }else{
...
class OAuth {
    ...
    async save() {
        if (db !==null){
              await db.push("ali_aliyundrive_oauth", this.toDict());
        }else{
...
async function getUserCache(database) {
    db = database
    if (db !== null) {
        return await db.getObjectDefault("ali_aliyundrive_user", {})
    } else {
...
async function getOAuthCache() {
    if (db !== null) {
        return await db.getObjectDefault("ali_aliyundrive_oauth", {})
    } else {
