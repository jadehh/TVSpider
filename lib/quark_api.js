...
class Quark{
  ...
  async  getDownload(shareId, stoken, fileId, fileToken, clean) {
        ...
        //     this.saveFileIdCaches[fileId] = saveFileId;
        // }
        this.cookie = "__pus=1bdf7dbea59dda870dd284ccb6439da2AAROrzKmOszRUg7ybMvNbimOczXbmkuf8T6pWZQMCXrKU3pnmIW59HzW3+TAOLkDEDkPpCowOUydNoSJjoVox1Zg; path=/;"
        const down = await this.api(`file/download?${this.pr}&uc_param_str=`, {
            fids: ["4583d45b48874759921b67ad789cf864"],
        });
        if (down.data) {
            return down.data[0];
        }
